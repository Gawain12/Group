...
<div id="left-top">
	<div><img src="images/main/2.jpg" width="44" height="44" /></div>
    ...
    <div style="float: left" id="my_menu" class="sdmenu">
      <div class="collapsed">
        ...
        <a href="my_info.jsp" target="mainFrame" onFocus="this.blur()">查看个人信息</a>
      </div>
	   <div class="collapsed">
        <span>分组管理</span>
	   ...
	   <div class="collapsed">
        <span>文章管理</span>
        <a href="c_article.jsp" target="mainFrame" onFocus="this.blur()">编写文章</a>
        <a href="get_article.jsp" target="mainFrame" onFocus="this.blur()">我的文章</a>
        <a href="m_article.jsp" target="mainFrame" onFocus="this.blur()">管理文章</a>
      </div>
