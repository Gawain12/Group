...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="header">
  <tr>
    <td rowspan="2" align="left" valign="top" id="logo"><img src="images/main/1.png" width="74" height="64"></td>
    <td align="left" valign="bottom">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="left" valign="bottom" id="header-name">TLGroup</td>
        <td align="right" valign="top" id="header-right">
        	<a href="loginOut" target="topFrame" onFocus="this.blur()" class="admin-out">注销</a>
